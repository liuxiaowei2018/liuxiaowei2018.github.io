import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.8048b864.js";const p="/assets/image-20230112164305474.87f3f051.png",e="/assets/image-20230112164654112.105ffaac.png",o="/assets/image-20230112164923407.f5db8b0f.png",t="/assets/image-20230112164940576.27f04feb.png",c="/assets/image-20230112165023728.b79e40d2.png",r="/assets/image-20230112165110441.a1197091.png",i="/assets/image-20230110115113929.297d393f.png",m=JSON.parse('{"title":"SpringBoot","description":"","frontmatter":{},"headers":[],"relativePath":"framework/springBoot.md","filePath":"framework/springBoot.md","lastUpdated":1697176108000}'),y={name:"framework/springBoot.md"},E=l(`<h1 id="springboot" tabindex="-1">SpringBoot <a class="header-anchor" href="#springboot" aria-label="Permalink to &quot;SpringBoot&quot;">​</a></h1><nav class="table-of-contents"><ul><li><a href="#原理篇">原理篇</a><ul><li><a href="#自动装配原理">自动装配原理</a></li><li><a href="#spring-boot启动流程">Spring Boot启动流程</a></li><li><a href="#springboot注解">SpringBoot注解</a></li></ul></li><li><a href="#应用篇">应用篇</a></li></ul></nav><h2 id="原理篇" tabindex="-1">原理篇 <a class="header-anchor" href="#原理篇" aria-label="Permalink to &quot;原理篇&quot;">​</a></h2><h3 id="自动装配原理" tabindex="-1">自动装配原理 <a class="header-anchor" href="#自动装配原理" aria-label="Permalink to &quot;自动装配原理&quot;">​</a></h3><p>Spring Boot关于自动配置的源码在<code>spring-boot-autoconfigure-x.x.x.x.jar</code>中</p><p>SpringBoot 的核心注解 <code>SpringBootApplication</code></p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">@</span><span style="color:#F97583;">Target</span><span style="color:#E1E4E8;">({ElementType.TYPE})</span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div>`,137),d=[E];function u(g,A,h,b,v,C){return n(),a("div",null,d)}const D=s(y,[["render",u]]);export{m as __pageData,D as default};
