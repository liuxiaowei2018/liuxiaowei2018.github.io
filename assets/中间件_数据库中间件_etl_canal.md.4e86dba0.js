import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.8048b864.js";const F=JSON.parse('{"title":"Canal","description":"","frontmatter":{},"headers":[],"relativePath":"中间件/数据库中间件/etl/canal.md","filePath":"中间件/数据库中间件/etl/canal.md","lastUpdated":null}'),p={name:"中间件/数据库中间件/etl/canal.md"},o=l(`<h1 id="canal" tabindex="-1">Canal <a class="header-anchor" href="#canal" aria-label="Permalink to &quot;Canal&quot;">​</a></h1><nav class="table-of-contents"><ul><li><a href="#_1、canal入门">1、Canal入门</a></li><li><a href="#_2、canal应用">2、Canal应用</a><ul><li><a href="#搭建canal环境">搭建Canal环境</a></li><li><a href="#springboot整合canal">springboot整合canal</a></li><li><a href="#canal-spring-boot-starter">canal-spring-boot-starter</a></li><li><a href="#canal实际测试">canal实际测试</a></li></ul></li><li><a href="#_3、canal扩展">3、Canal扩展</a><ul><li><a href="#mysql主备复制原理">MySQL主备复制原理</a></li><li><a href="#canal-工作原理">canal 工作原理</a></li></ul></li></ul></nav><h2 id="_1、canal入门" tabindex="-1">1、Canal入门 <a class="header-anchor" href="#_1、canal入门" aria-label="Permalink to &quot;1、Canal入门&quot;">​</a></h2><p><img src="https://cdn.jsdelivr.net/gh/liuxiaowei2018/image/repo/202405301631053.png" alt="image-20230615143902357"></p><p><strong>canal [kə&#39;næl]</strong>，译意为水道/管道/沟渠，主要用途是基于 MySQL 数据库增量日志解析，提供增量数据订阅和消费</p><p>早期阿里巴巴因为杭州和美国双机房部署，存在跨机房同步的业务需求，实现方式主要是基于业务 trigger 获取增量变更。从 2010 年开始，业务逐步尝试数据库日志解析获取增量变更进行同步，由此衍生出了大量的数据库增量订阅和消费业务。</p><p>基于日志增量订阅和消费的业务包括</p><ul><li>数据库镜像</li><li>数据库实时备份</li><li>索引构建和实时维护(拆分异构索引、倒排索引等)</li><li>业务 cache 刷新</li><li>带业务逻辑的增量数据处理</li></ul><p>当前的 canal 支持源端 MySQL 版本包括 5.1.x , 5.5.x , 5.6.x , 5.7.x , 8.0.x</p><blockquote><p>官方文档：<a href="https://github.com/alibaba/canal/wiki/QuickStart" target="_blank" rel="noreferrer">https://github.com/alibaba/canal/wiki/QuickStart</a></p></blockquote><h2 id="_2、canal应用" tabindex="-1">2、Canal应用 <a class="header-anchor" href="#_2、canal应用" aria-label="Permalink to &quot;2、Canal应用&quot;">​</a></h2><h3 id="搭建canal环境" tabindex="-1">搭建Canal环境 <a class="header-anchor" href="#搭建canal环境" aria-label="Permalink to &quot;搭建Canal环境&quot;">​</a></h3><h4 id="mysql配置" tabindex="-1">mysql配置 <a class="header-anchor" href="#mysql配置" aria-label="Permalink to &quot;mysql配置&quot;">​</a></h4><blockquote><p>当前的canal开源版本支持5.7及以下的版本</p></blockquote><blockquote><p>canal的原理是基于mysql binlog技术，需要开启mysql的binlog写入功能，并且配置binlog模式为row。</p></blockquote><div class="language-properties vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">properties</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">[mysqld]</span><span style="color:#E1E4E8;">  </span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h2 id="_3、canal扩展" tabindex="-1">3、Canal扩展 <a class="header-anchor" href="#_3、canal扩展" aria-label="Permalink to &quot;3、Canal扩展&quot;">​</a></h2><h3 id="mysql主备复制原理" tabindex="-1">MySQL主备复制原理 <a class="header-anchor" href="#mysql主备复制原理" aria-label="Permalink to &quot;MySQL主备复制原理&quot;">​</a></h3><p><img src="https://cdn.jsdelivr.net/gh/liuxiaowei2018/image/repo/202405301632665.png" alt="image-20230615143944915"></p><ul><li>MySQL master 将数据变更写入二进制日志( binary log, 其中记录叫做二进制日志事件binary log events，可以通过 show binlog events 进行查看)</li><li>MySQL slave 将 master 的 binary log events 拷贝到它的中继日志(relay log)</li><li>MySQL slave 重放 relay log 中事件，将数据变更反映它自己的数据</li></ul><h3 id="canal-工作原理" tabindex="-1">canal 工作原理 <a class="header-anchor" href="#canal-工作原理" aria-label="Permalink to &quot;canal 工作原理&quot;">​</a></h3><ul><li>canal 模拟 MySQL slave 的交互协议，伪装自己为 MySQL slave ，向 MySQL master 发送dump 协议</li><li>MySQL master 收到 dump 请求，开始推送 binary log 给 slave (即 canal )</li><li>canal 解析 binary log 对象(原始为 byte 流)</li></ul>`,72),e=[o];function t(c,r,E,y,i,u){return a(),n("div",null,e)}const q=s(p,[["render",t]]);export{F as __pageData,q as default};
