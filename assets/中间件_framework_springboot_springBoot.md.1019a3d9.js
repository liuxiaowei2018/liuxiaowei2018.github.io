import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.8048b864.js";const g=JSON.parse('{"title":"SpringBoot","description":"","frontmatter":{},"headers":[],"relativePath":"中间件/framework/springboot/springBoot.md","filePath":"中间件/framework/springboot/springBoot.md","lastUpdated":null}'),p={name:"中间件/framework/springboot/springBoot.md"},e=l(`<h1 id="springboot" tabindex="-1">SpringBoot <a class="header-anchor" href="#springboot" aria-label="Permalink to &quot;SpringBoot&quot;">​</a></h1><nav class="table-of-contents"><ul><li><a href="#_1、springboot应用">1、SpringBoot应用</a></li><li><a href="#_2、springboot扩展">2、SpringBoot扩展</a><ul><li><a href="#springboot自动装配原理">SpringBoot自动装配原理</a></li><li><a href="#spring-boot启动流程">Spring Boot启动流程</a></li><li><a href="#springboot注解">SpringBoot注解</a></li><li><a href="#springboot配置文件">SpringBoot配置文件</a></li></ul></li></ul></nav><h2 id="_1、springboot应用" tabindex="-1">1、SpringBoot应用 <a class="header-anchor" href="#_1、springboot应用" aria-label="Permalink to &quot;1、SpringBoot应用&quot;">​</a></h2><h4 id="springboot-参数校验" tabindex="-1">SpringBoot 参数校验 <a class="header-anchor" href="#springboot-参数校验" aria-label="Permalink to &quot;SpringBoot 参数校验&quot;">​</a></h4><h5 id="版本依赖" tabindex="-1">版本依赖 <a class="header-anchor" href="#版本依赖" aria-label="Permalink to &quot;版本依赖&quot;">​</a></h5><p>如果spring-boot版本小于2.3.x，spring-boot-starter-web会自动传入hibernate-validator依赖</p><p>如果spring-boot版本大于2.3.x，则需要手动引入依赖：</p><div class="language-xml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">xml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">dependency</span><span style="color:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><p><code>getAutoConfigurationEntry()</code>方法，这个方法主要负责加载自动配置类的</p><p><img src="https://cdn.jsdelivr.net/gh/liuxiaowei2018/image/repo/202405301536888.png" alt="image-20230112164654112"></p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">private</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">static</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">final</span><span style="color:#E1E4E8;"> AutoConfigurationEntry EMPTY_ENTRY </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">new</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">AutoConfigurationEntry</span><span style="color:#E1E4E8;">();</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><p><strong>第 1 步</strong>:</p><p>判断自动装配开关是否打开。默认<code>spring.boot.enableautoconfiguration=true</code>，可在 <code>application.properties</code> 或 <code>application.yml</code> 中设置</p><p><img src="https://cdn.jsdelivr.net/gh/liuxiaowei2018/image/repo/202405301536951.png" alt="image-20230112164923407"></p><p><strong>第 2 步</strong> ：</p><p>用于获取<code>EnableAutoConfiguration</code>注解中的 <code>exclude</code> 和 <code>excludeName</code>。</p><p><strong>第 3 步</strong></p><p>获取需要自动装配的所有配置类，读取<code>META-INF/spring.factories</code></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">spring-boot/spring-boot-project/spring-boot-autoconfigure/src/main/resources/META-INF/spring.factories</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">spring-boot/spring-boot-project/spring-boot-autoconfigure/src/main/resources/META-INF/spring.factories</span></span></code></pre></div><p><img src="https://cdn.jsdelivr.net/gh/liuxiaowei2018/image/repo/202405301536166.png" alt="image-20230112165023728"></p><p><strong>第 4 步</strong> ：</p><p>筛选，<code>@ConditionalOnXXX</code> 中的所有条件都满足，该类才会生效。</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">//举例: RabbitAutoConfiguration</span></span>
