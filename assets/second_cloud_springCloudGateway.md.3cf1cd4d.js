...
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></blockquote><h2 id="动态路由" tabindex="-1">动态路由 <a class="header-anchor" href="#动态路由" aria-label="Permalink to &quot;动态路由&quot;">​</a></h2><p>// todo</p>`,14),t=[e];function r(c,E,y,i,g,d){return a(),n("div",null,t)}const F=s(o,[["render",r]]);export{A as __pageData,F as default};
