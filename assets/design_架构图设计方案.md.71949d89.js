import{_ as s,c as a,o as n,a as e}from"./app.467f35a9.js";const l="/assets/image-20220309155637462.fda7eaef.png",p="/assets/image-20220309155804989.c4bc08df.png",c="/assets/image-20220309155917023.710f5320.png",t="/assets/image-20220309160053599.372dc99b.png",i="/assets/image-20220309160154946.1ed98a32.png",o="/assets/image-20220309160255362.89930330.png",r="/assets/image-20220309160338530.b65784a6.png",d="/assets/image-20220309160429856.87328af8.png",A="/assets/image-20220309160454497.dd95f056.png",C="/assets/image-20220309160544784.2b634c3c.png",k=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"架构图设计方案","slug":"架构图设计方案","link":"#架构图设计方案","children":[{"level":3,"title":"4R架构","slug":"_4r架构","link":"#_4r架构","children":[]},{"level":3,"title":"4+1架构视图","slug":"_4-1架构视图","link":"#_4-1架构视图","children":[]},{"level":3,"title":"常见架构图","slug":"常见架构图","link":"#常见架构图","children":[]},{"level":3,"title":"系统时序图","slug":"系统时序图","link":"#系统时序图","children":[]}]}],"relativePath":"design/架构图设计方案.md"}'),h={name:"design/架构图设计方案.md"},g=e('<h2 id="架构图设计方案" tabindex="-1">架构图设计方案 <a class="header-anchor" href="#架构图设计方案" aria-hidden="true">#</a></h2><h3 id="_4r架构" tabindex="-1">4R架构 <a class="header-anchor" href="#_4r架构" aria-hidden="true">#</a></h3><p><img src="'+l+'" alt="image-20220309155637462"></p><h3 id="_4-1架构视图" tabindex="-1">4+1架构视图 <a class="header-anchor" href="#_4-1架构视图" aria-hidden="true">#</a></h3><p><img src="'+p+'" alt="image-20220309155804989"></p><h3 id="常见架构图" tabindex="-1">常见架构图 <a class="header-anchor" href="#常见架构图" aria-hidden="true">#</a></h3><p><img src="'+c+'" alt="image-20220309155917023"></p><h4 id="业务架构" tabindex="-1">业务架构 <a class="header-anchor" href="#业务架构" aria-hidden="true">#</a></h4><p><img src="'+t+'" alt="image-20220309160053599"></p><h4 id="客户端架构、前端架构" tabindex="-1">客户端架构、前端架构 <a class="header-anchor" href="#客户端架构、前端架构" aria-hidden="true">#</a></h4><p><img src="'+i+'" alt="image-20220309160154946"></p><h4 id="系统架构" tabindex="-1">系统架构 <a class="header-anchor" href="#系统架构" aria-hidden="true">#</a></h4><p><img src="'+o+'" alt="image-20220309160255362"></p><p><img src="'+r+'" alt="image-20220309160338530"></p><h4 id="应用架构" tabindex="-1">应用架构 <a class="header-anchor" href="#应用架构" aria-hidden="true">#</a></h4><p><img src="'+d+'" alt="image-20220309160429856"></p><h4 id="部署架构" tabindex="-1">部署架构 <a class="header-anchor" href="#部署架构" aria-hidden="true">#</a></h4><p><img src="'+A+'" alt="image-20220309160454497"></p><h3 id="系统时序图" tabindex="-1">系统时序图 <a class="header-anchor" href="#系统时序图" aria-hidden="true">#</a></h3><p><img src="'+C+`" alt="image-20220309160544784"></p><h4 id="时序图学习" tabindex="-1">时序图学习 <a class="header-anchor" href="#时序图学习" aria-hidden="true">#</a></h4><h5 id="idea-plantuml" tabindex="-1">idea-PlantUML <a class="header-anchor" href="#idea-plantuml" aria-hidden="true">#</a></h5><blockquote><h6 id="时序图" tabindex="-1">时序图 <a class="header-anchor" href="#时序图" aria-hidden="true">#</a></h6><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">@startuml</span></span>
...
<span class="line"><span style="color:#A6ACCD;">@enduml</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ul><li><p>本时序图关键说明如下：</p></li><li><ul><li><code>title</code>可以用于指定UML图的标题；</li></ul></li><li><p>通过<code>actor</code>可以声明人形的参与者；</p></li><li><p>通过<code>participant</code>可以声明普通类型的参与者；</p></li><li><p>通过<code>as</code>可以给参与者取别名；</p></li><li><p>通过<code>-&gt;</code>可以绘制参与者之间的关系，虚线箭头可以使用<code>--&gt;</code>；</p></li><li><p>在每个参与者关系后面，可以使用<code>:</code>给关系添加说明；</p></li><li><p>通过<code>autonumber</code>我们可以给参与者关系自动添加序号；</p></li><li><p>通过<code>activate</code>和<code>deactivate</code>可以指定参与者的生命线。</p></li><li><p>右键时序图时，可以生成一个在线访问的链接；</p></li><li><p>直接访问这个链接，可以在线访问UML时序图，并进行编辑</p></li></ul><h5 id="活动图" tabindex="-1">活动图 <a class="header-anchor" href="#活动图" aria-hidden="true">#</a></h5><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">@startuml</span></span>
...
<span class="line"><span style="color:#A6ACCD;">stop</span></span>
<span class="line"><span style="color:#A6ACCD;">@enduml</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ul><li><p>本活动图关键说明如下：</p></li><li><ul><li>通过<code>start</code>和<code>stop</code>可以表示流程的开始和结束；</li></ul></li><li><p>通过<code>:</code>和<code>;</code>中间添加文字来定义活动流程节点；</p></li><li><p>通过<code>if</code>+<code>then</code>+<code>endif</code>定义条件判断；</p></li><li><p>通过<code>switch</code>+<code>case</code>+<code>endswitch</code>定义switch判断。</p></li></ul></blockquote>`,23),u=[g];function y(_,D,m,f,v,b){return n(),a("div",null,u)}const q=s(h,[["render",y]]);export{k as __pageData,q as default};
